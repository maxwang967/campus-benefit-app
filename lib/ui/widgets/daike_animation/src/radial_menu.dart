...
import 'package:campus_benefit_app/ui/widgets/daike_animation/src/radial_menu_button.dart';
import 'package:campus_benefit_app/ui/widgets/daike_animation/src/radial_menu_center_button.dart';
import 'package:campus_benefit_app/ui/widgets/daike_animation/src/radial_menu_item.dart';
...
class RadialMenuState extends State<RadialMenu> with TickerProviderStateMixin {
  ...
  double calculateItemAngle(int index) {
    double _itemSpacing = 188.0 / widget.items.length;
    return 60 + index * _itemSpacing * _radiansPerDegree;
  }
...
class _RadialMenuLayout extends MultiChildLayoutDelegate {
  ...
  void performLayout(Size size) {
    center = new Offset(size.width/2 , size.height/1.07 );
