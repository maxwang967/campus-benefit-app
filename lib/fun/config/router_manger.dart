...
import 'package:campus_benefit_app/fun/ui/page/coin/coin_ranking_list_page.dart';
import 'package:campus_benefit_app/fun/ui/page/coin/coin_record_list_page.dart';
import 'package:campus_benefit_app/fun/ui/page/favourite_list_page.dart';
import 'package:campus_benefit_app/fun/ui/page/article/article_list_page.dart';
import 'package:campus_benefit_app/fun/ui/page/setting_page.dart';
import 'package:campus_benefit_app/fun/ui/page/tab/home_second_floor_page.dart';
import 'package:campus_benefit_app/fun/ui/page/user/login_page.dart';
import 'package:campus_benefit_app/fun/ui/page/splash.dart';
import 'package:campus_benefit_app/fun/ui/page/tab/tab_navigator.dart';
import 'package:campus_benefit_app/fun/ui/page/article/article_detail_page.dart';
import 'package:campus_benefit_app/fun/ui/page/article/article_detail_plugin_page.dart';
import 'package:campus_benefit_app/fun/ui/page/user/register_page.dart';
import 'package:campus_benefit_app/fun/ui/widget/page_route_anim.dart';
