import 'package:campus_benefit_app/fun/config/net/wan_android_api.dart';
import 'package:campus_benefit_app/fun/model/article.dart';
import 'package:campus_benefit_app/fun/model/banner.dart';
import 'package:campus_benefit_app/fun/model/coin_record.dart';
import 'package:campus_benefit_app/fun/model/search.dart';
import 'package:campus_benefit_app/fun/model/navigation_site.dart';
